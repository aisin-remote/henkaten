                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-0 text-truncate">
                            <img src="{{ asset('uploads/doc/' . $emp->photo) }}" class="rounded img-fluid me-2" width="40" alt="{{ $emp->name }}">
                        ...
                        <td>
                            <div style="background-color: lightgreen; width:10px; height:10px; border-radius:100%; display:inline-block; margin-right:2px">
                            </div>
                            {{ $emp->status }}
                        </td>
                        <td class="text-center">
                            ...
                            <a href="#" class="btn btn-danger delete-employee" data-employee-id="{{ $emp->id }}">
                                <span class="rounded-3" id="icon">
                                    <i class="ti ti-x"></i>
                                </span>
                            </a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12">
                        <div class="text-center">
                            <img src="{{ asset('uploads/doc/' . $emp->photo) }}" class="rounded-1 img-fluid" width="150">
                            <div class="mt-n2">
