            ...
            <div class="card-body">
                <div class="text-white">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card p-4 py-4">
                                <div class="card-body p-3 align-items-center text-center" style="max-height: 11em; width: 100%; overflow:scroll; overflow-x: hidden">
                                    @if ($histories !== [])
                                    <div class="accordion" id="accordionExample">
                                        @foreach ($histories as $history)
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#history-{{ $loop->index }}" aria-expanded="false" aria-controls="collapseOne">
                                                    <span class="mb-1 badge bg-dark me-2">{{ $history['line'] }}</span>
                                            ...
                                            <div id="history-{{ $loop->index }}" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
