...
@section('main')
    ...
    <div class="row" style="margin-top: -30px">
        <div class="col-lg-6 col-md-12 col-12">
            <div class="card shadow-md card-hover">
                <div class="card-body p-3 d-flex align-items-center gap-3" id="themeContainer">
                    ...
                    <button type="button" class="btn btn-{{ $themeName ? 'secondary' : 'light' }} py-2 px-5 ms-auto"
                        data-bs-toggle="modal" data-bs-target="#modalTheme"
                        style="border: 3px {{ $themeName ? 'none' : 'dotted' }} {{ $themeName ? 'lightgrey' : '#686868' }}">
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <select class="select2 form-control select2-hidden-accessible"
                                style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="themeSelect">
                            ...
                            <div class="mt-3">
                                <label class="mb-2">Custom Theme</label>
                                <input type="text" class="form-control" id="customThemeInput"
                                    placeholder="Custom Theme" name="custom_theme">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                ...
                <div class="modal-content">
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <label class="mb-2">New PIC</label>
                            <select class="select2 form-control select2-hidden-accessible"
                                style="width: 100%; height: 36px" data-select2-id="select2-data-1-lmv6" tabindex="-1"
                                aria-hidden="true" id="firstPicSelect" required>
                                <option data-select2-id="select2-data-3-t8ia" value="0">Select</option>
                                @foreach ($employees as $employee)
                                    <option data-select2-id="select2-data-3-t8ia" value="{{ $employee->id }}">
                                        {{ $employee->name }}
        ...
        {{-- 2 PIC modal --}}
        <div class="modal fade" id="secondPicModal" tabindex="-1" aria-labelledby="themeModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <select class="select2 form-control select2-hidden-accessible"
                                style="width: 100%; height: 36px" data-select2-id="select2-data-1-lmv6" tabindex="-1"
                                aria-hidden="true" id="secondPicSelect" required>
                                <option data-select2-id="select2-data-3-t8ia" value="0">Select</option>
                                @foreach ($employees as $employee)
                                    <option data-select2-id="select2-data-3-t8ia" value="{{ $employee->id }}">
                                        {{ $employee->name }}
        ...
        <!-- pic modal 2 -->
        <div class="modal fade" id="secondPicModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <select class="select2 form-control select2-hidden-accessible"
                                style="width: 100%; height: 36px" data-select2-id="select2-data-1-lmv6" tabindex="-1"
                                aria-hidden="true" id="secondPicSelect">
