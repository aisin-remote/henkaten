...
<div class="col-12 col-lg-12">
    ...
    <div class="card shadow" id="addSkillCard" style="display: none">
        <div class="border-bottom title-part-padding">
            <h3 class="card-title mb-0">Add New Theme</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('theme.regist') }}" method="POST" class="mt-4">
                @csrf
                @method('POST')
                    ...
                    <div data-repeater-list="repeater-group">
                        <div data-repeater-item="" class="row mb-3">
                            <div class="col-lg-11 col-sm-12">
                                <input type="text" class="form-control" placeholder="Theme" name="name" required>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-2 text-end">
                    <button class="btn btn-primary px-4 py-2" id="addSkill">
                        ...
                        <span class="d-none d-sm-inline-block">Add Theme</span>
                    </button>
                </div>
            </div>
        </div>
        <div class="card-body p-3">
            <table class="table text-nowrap align-middle mb-0" id="masterSkill" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $theme->name }}</td>
                        <td><a class="btn btn-danger delete-skill" href="#" data-min-id="{{ $theme->id }}">
