...
<div class="modal fade" id="{{ $modal['modalId'] }}" tabindex="-1" aria-labelledby="bs-example-modal-lg" style="display: none;" aria-hidden="true">
            ...
            <form class="mt-3" action="{{ route('dashboard.storeHenkaten') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="statusRadio text-center mt-3">
                        <label class="btn btn-light-primary text-primary font-medium me-2">
                            <div class="form-check">
                                <input type="radio" id="{{ $modal['modalId'] }}HenkatenRadio" class="other-radio form-check-input" name="status" value="henkaten">
                        ...
                        <label class="btn btn-light-primary text-primary font-medium">
                            <div class="form-check">
                                <input type="radio" id="{{ $modal['modalId'] }}StopRadio" class="other-radio form-check-input" name="status" value="stop">
                    ...
                    <div class="form-group mt-3 pic-form">
                        ...
                        <select class="select2 form-control select2-hidden-accessible category" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="{{ $modal['modalId'] }}Category" name="category" required>
                    ...
                    <div class="form-group mt-3 pic-form">
                        ...
                        <select class="select2 form-control select2-hidden-accessible hanketenManagement" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="{{ $modal['modalId'] }}TableManagement" name="henkatenManagement" required>
                    ...
                    <div class="form-group mt-3 mb-3 description">
                        ...
                        <input class="form-control" rows="3" placeholder="Abnormality..." name="abnormality" id="{{ $modal['modalId'] }}Abnormality" required>
                        </input>
                    </div>
                </div>
...
{{-- modal error --}}
<div class="modal fade" id="manModal-flag" tabindex="-1" aria-labelledby="bs-example-modal-lg" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content modal-filled bg-light-danger">
            <div class="modal-body p-4">
                <div class="text-center text-danger">
                    ...
                    <a href="{{ route('employeePlanning.index') }}" type="button" class="btn btn-secondary font-medium waves-effect text-start">
                        Create Planning
                    </a>
                </div>
            </div>
        ...
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 align-item-center" style="margin-bottom: -28px">
                    <div class="card bg-{{ $color_status }} overflow-hidden card-hover" data-bs-toggle="modal" data-bs-target="#ModalStatus">
                        <div class="d-flex">
...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <img src="{{ asset('assets/images/' . $lineMap->photo) }}" alt="" class="mw-100" usemap="#roomMap" width="980vh">
        ...
        <div style="position: absolute; top: {{ $emp->pos->top }}vh; left: {{ $emp->pos->left }}vh;">
            <img src="{{ asset('uploads/doc/' . $photo) }}" alt="Employee Photo" style="width: {{ $emp->pos->size }}; height: {{ $emp->pos->size }};" class="rounded-1" />
        </div>
        @endforeach
        @else
        @foreach ($activeEmployees as $emp)
    ...
    <div class="col-lg-6">
        <div class="row text-center">
            ...
            @endphp
            <div class="col-lg-12">
                <div class="card overflow-hidden card-hover" data-bs-toggle="modal" data-bs-target="{{ $target }}">
        ...
        <div class="row">
                        ...
                        <div class="col-lg-{{ $col }} col-md-12">
                            <div class="item">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img src="{{ asset('uploads/doc/' . $photo) }}" class="rounded-1 center" height="100" style="width: 100px !important; margin-left: auto;
                                                    margin-right: auto;">
                                        <div class="mt-n2">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <button class="btn btn-light-danger text-danger" style="width: 100% !important">POS
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card text-center">
                    <div class="card-body">
                        <img src="{{ asset('uploads/doc/' . $activePic->employee->photo) }}" class="rounded-1" width="100" height="100">
                        <div class="mt-n2">
                            <span class="badge bg-{{ $picColor }}">{{ strtoupper($activePic->employee->role) }}</span>
            ...
            <table class="table table-responsive-lg" id="henkatenHistory" style="width:100%">
                ...
                <tbody style="font-size: 15px">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-secondary view-employee detail" data-bs-toggle="modal" data-bs-target="" data-history-id="{{ $history['id'] }}">
                                <span class="rounded-3" id="icon">
                                    <i class="ti ti-search"></i>
                                </span>
                            </button>
                            @can('JP')
                            <button class="btn btn-warning troubleshoot" data-history-id="{{ $history['id'] }}">
                                <span class="rounded-3" id="icon">
                        ...
                        <td class="text-center">
                            ...
                            @can('JP')
                            <button class="btn btn-warning troubleshoot" data-history-id="{{ $history['id'] }}" disabled>
                                <span class="rounded-3" id="icon">
                                    <i class="ti ti-edit"></i>
                                </span>
                            </button>
                        ...
                        <td class="text-center">
                            @if ($history->is_done === '0')
                            <button class="btn btn-success approve" data-history-id="{{ $history['id'] }}">
                                <span class="rounded-3">
                                    <i class="ti ti-checks"></i>
                                </span>
                            </button>
                            @else
                            <button class="btn btn-success approve" data-history-id="{{ $history['id'] }}" disabled>
                                <span class="rounded-3">
                                    <i class="ti ti-checks"></i>
                                </span>
                            </button>
...
@endphp
<div class="modal fade modal-lg troubleshootModal" id="{{ $history['id'] }}Troubleshoot" tabindex="-1" aria-labelledby="bs-example-modal-xl" style="display: none;" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12 mb-1">
                            ...
                            <div class="form-group mt-3 mb-3 description" style="display: none;">
                                ...
                                <input class="form-control" rows="3" placeholder="Troubleshoot..." name="troubleshoot" id="troubleshoot" required>
                                </input>
                            </div>
                        </div>
                    </div>
                    <div class="accordion accordion-flush position-relative overflow-hidden mt-2" id="{{ $accordionId }}">
                        <div class="row">
                            <div class="col-12">
                                <div class="accordion-item mb-3 border rounded-top rounded-bottom">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button fs-4 fw-bolder px-3 py-6 lh-base border-0 rounded-top collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#{{ $collapseOneId }}" aria-expanded="false" aria-controls="{{ $collapseOneId }}">
                                            Quality Inspections
                                        </button>
                                    </h2>
                                    <div id="{{ $collapseOneId }}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#{{ $accordionId }}" style="">
                                        <div class="accordion-body px-3 fw-normal">
                                            <div class="text-center mb-2">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <input class="form-check-input" type="radio" name="inspection" id="need" value="need">
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="inspection" id="noNeed" value="no need">
                                            ...
                                            <div class="row ">
                                                <div class="col-12 mb-3">
                                                    <div class="form-group pic-form">
                                                        ...
                                                        <input type="text" class="form-control" id="part" name="part" placeholder="TCC d983">
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-3">
                                                    <div class="form-group pic-form">
                                                        <label class="form-label mb-2 fw-semibold">Before
                                                            Treatment</label>
                                                        <select class="select2 form-control select2-hidden-accessible beforeTreatment" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="{{ $history['id'] }}BeforeTreatment" name="beforeTreatment" required>
                                                            <option value="0">-- Select --</option>
                                                ...
                                                <div class="col-12 mb-3">
                                                    <div class="form-group pic-form">
                                                        <label class="form-label mb-2 fw-semibold">After
                                                            Treatment</label>
                                                        <select class="select2 form-control select2-hidden-accessible" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="{{ $history['id'] }}AfterTreatment" name="afterTreatment" required>
                                                            <option value="0">-- Select --</option>
                                                            <option value="ok">OK</option>
                                                            <option value="ng">NG</option>
                                                        </select>
                            ...
                            <div class="col-12">
                                <div class="accordion-item mb-3 border rounded-top rounded-bottom">
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        <button class="accordion-button fs-4 fw-semibold px-3 py-6 lh-base border-0 rounded-bottom collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#{{ $collapseThreeId }}" aria-expanded="false" aria-controls="{{ $collapseThreeId }}">
                                            Safety
                                        </button>
                                    </h2>
                                    <div id="{{ $collapseThreeId }}" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#{{ $accordionId }}" style="">
                                        <div class="accordion-body px-3 fw-normal">
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <div class="form-group pic-form">
                                                        <label class="form-label mb-2 fw-semibold">Result
                                                            Check</label>
                                                        <select class="select2 form-control select2-hidden-accessible" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="{{ $history['id'] }}ResultCheck" name="resultCheck" required>
                                                            <option value="0">-- Select --</option>
                                                            <option value="ok">OK</option>
                                                            <option value="ng">NG</option>
                                                        </select>
                            ...
                            <div class="col-12">
                                <div class="accordion-item mb-3 border rounded-top rounded-bottom">
                                    @if ($history->{"4M"} === 'man')
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button fs-4 fw-bolder px-3 py-6 lh-base border-0 rounded-top collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#{{ $collapseTwoId }}" aria-expanded="false" aria-controls="{{ $collapseTwoId }}">
                                            Man Henkaten <small class="text-danger ps-1"> *Jika
                                                ada
                                                perubahan</small>
                                        </button>
                                    </h2>
                                    <div id="{{ $collapseTwoId }}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#{{ $accordionId }}" style="">
                                        <div class="accordion-body px-3 fw-normal">
                                            @foreach ($activeEmployees as $emp)
                                            <div class="row mt-1">
                                                <div class="col-lg-1">
                                                    <label for="exampleInputPassword1" class="form-label fw-semibold" style="color: white">Pos</label>
                                                    <p class="mt-2 text-center badge bg-danger rounded-pill">
                                                        Pos
                                                        {{ $emp->pos->pos }}
                                                    </p>
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="mb-4">
                                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Current
                                                            Employee</label>
                                                        <input type="text" class="form-control" id="employeeBefore" placeholder="John" value="{{ $emp->employee->name }}" disabled>

                                                        <input type="hidden" class="form-control employeeBefore" name="before[]" placeholder="John" value="{{ $emp->employee->id }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-1">
                                                    <label for="exampleInputPassword1" class="form-label fw-semibold" style="color: white">Last</label>
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="mb-4">
                                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Replacement
                                                            Employee</label>
                                                        <select class="select2 form-select select2-hidden-accessible employeeReplacement" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" name="after[]" required>
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <select class="select2 form-control" style="width: 100%; height: 36px" tabindex="-1" aria-hidden="true" id="{{ $history['id'] }}DoneBy" name="doneBy" required>
...
{{-- modal approve --}}
@foreach ($histories as $history)
<div class="modal fade modal-md" id="{{ $history['id'] }}Approve" tabindex="-1" aria-labelledby="bs-example-modal-xl" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title" id="myLargeModalLabel">
...
@endphp
<div class="modal fade modal-md" id="{{ $history['id'] }}Detail" tabindex="-1" aria-labelledby="bs-example-modal-xl" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title" id="myLargeModalLabel">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills nav-fill mt-4" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-bs-toggle="tab" href="#{{ $history['id'] }}Abnormal" role="tab" aria-selected="true">
                                <span>Abnormality</span>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#{{ $history['id'] }}Trouble" role="tab" aria-selected="true" tabindex="-1">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history['4M']) }}" disabled>
                                        <label for="tb-fname">4M</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history['category']) }}" disabled>
                                        <label for="tb-fname">Category</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ $history->henkatenManagement->henkaten_item }} [Table no: {{ $history->henkatenManagement->table_no }}]" disabled>
                                        <label for="tb-fname">Hankaten Table No.</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history['abnormality']) }}" disabled>
                                        <label for="tb-fname">Abnormality Content</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ Carbon\Carbon::parse($history['date'])->format('j F Y,  H:i:s') }}" disabled>
                        ...
                        <div class="tab-pane p-3" id="{{ $history['id'] }}Trouble" role="tabpanel">
                            <div class="row">
                                <div class="col-12 text-center">
                                    ...
                                    @else
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->troubleshoot) }}" disabled>
                                        <label for="tb-fname">Troubleshoot</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->result_check) }}" disabled>
                                        <label for="tb-fname">Result Check</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->inspection_report) }}" disabled>
                                        <label for="tb-fname">Inspection Report</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->part) }}" disabled>
                                        <label for="tb-fname">Part</label>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->before_treatment) }}" disabled>
                                                <label for="tb-fname">Before Treatment</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->after_treatment) }}" disabled>
                                                <label for="tb-fname">After Treatment</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control fw-bolder" id="tb-fname" placeholder="Enter Name here" value="{{ strtoupper($history->troubleshoot->employee->name) }}" disabled>
            ...
            <div class="modal-body">
                ...
                <form id="statusForm">
                    <div class="form-check mt-3">
                        <input class="form-check-input" type="radio" id="OffSwitch" name="switchStatus" value="off">
                        <label class="form-check-label" for="OffSwitch">Turn Off</label>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input" type="radio" id="RunningSwitch" name="switchStatus" value="running">
