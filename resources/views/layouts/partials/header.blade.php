        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-xl-block">
                <a href="#" class="text-nowrap nav-link">
                    <img src="{{ asset('assets/images/henkaten-logo.svg') }}" class="dark-logo" width="180" alt="" />
                </a>
            </li>
            <li class="nav-item d-none d-xl-block">
                        ...
                        <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <div class="user-profile-img">
                                    <img src="../../dist/images/profile/saiful.png" class="rounded-circle" width="35" height="35" alt="" />
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                    <img src="../../dist/images/profile/saiful.png" class="rounded-circle" width="80" height="80" alt="" />
                                    <div class="ms-3">
...
<script>
    ...
    // Tampilkan hasil shift
    console.log(shift);
        // Perbarui nilai pada elemen shift
        shiftElement.innerHTML = shift || "Shift 1"; // Jika tidak ada shift yang sesuai, tetapkan Shift 1 sebagai default
    }
